              ...
              [
                Node.text
                  "A city simulator, in which you are playing from birds-eye \
                   ...
                   and building the city. You can add residences and \
                   businesses. You can also set tax rates to make money. The \
                   city will have a happiness score calculated based on the \
                   ratio of businesses to residences, as well as the tax rate. \
                   Your goal is to make a profitable city, while also ensuring \
              ...
              [
                Node.text
                  "Calculated based on the number buildings you have placed \
                   down, money accumulated, and happiness acquired during your \
                   term as mayor.";
              ];
